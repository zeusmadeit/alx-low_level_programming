...
/**
 * binary_search_recursion - helper to advanced_binary, recursively searches for a value in an integer array
 ...
 * @value: value to search for
 *
 * Return: first index containing `value`, or else returns -1 if `value` is not 
 * found or if the array is NULL
 */
